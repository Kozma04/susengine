...
void log_setLogStyle(const LogStyle style) { g_logStyle = style; }

void log_setGlobalThreshold(const LogLevel thres) { g_logThres = thres; }

void log_setHeaderThreshold(const char *const strHeaderFile,
...
uint8_t log_levelIsVisibleHeader(const char *const strHeaderFile,
